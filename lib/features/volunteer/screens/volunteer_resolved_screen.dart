...
class VolunteerResolvedScreen extends StatelessWidget {
  ...
  const VolunteerResolvedScreen({super.key, this.resolvedData});

  @override
  Widget build(BuildContext context) {
    final victimName = resolvedData?['victimName'] ?? 'Sneha Kapoor';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Subtitle
              Text(
                '$victimName is safe. Thank you for your swift on-site intervention as a verified safety volunteer.',
                textAlign: TextAlign.center,
